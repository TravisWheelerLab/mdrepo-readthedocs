...
* A simulation metadata file named `mdrepo-metadata.toml` in TOML format. Use the provided form to generate a file or download the mdr-meta to generate and validate metadata files in the TOML Specification (next).
